    ...
    <div class="content pb70">
      ...
      >
        <p>
          ...
          있어준 게 너<span>라</span>는 사실에, 그리고 그 이후에도 여전히 내
          곁에 네가 남아 있다는 사실에 안도하고, 감사 <span>해</span>.<br />넌
          ...
          구<span>해</span>준 재료 덕분에 이제 거의 다 된 것 같아. <br />그 때가
      ...
      >
        <p>
          ...
          <span>미</span>안해.<br />아무리 저스티스가 널 해<span>치</span>지
          않았다지만, 애당초에 이런 일을 겪지 않<span>도</span>록 내가 더
          신경썼어야 했는데.<br />요새 나의 어두운 일면이 점점 더 자주 일상을
          차지하는 비중이 늘어나<span>는</span> 것 같아 초조<span>해.</span
          ><br />네게 더이상 피해를 주지 않기 위해서<span>라</span>도 나는 더
          빨리 그와 분리되어야 <span>해</span>.<br />네가 전에 직접 고생하며
          구해준 재료 덕분에 이제 거의 다 된 것 같아.<br />
